            ...
            <ul className="restaurant-list">
                ...
                <li className="restaurant">
                    ...
                    <div className="restaurant__info">
                        ...
                        <p className="restaurant__description text-body">평양 출신의 할머니가 수십 년간 운영해온 비지 전문점 피양콩 할마니. 두부를 빼지 않은 되비지를 맛볼 수 있는
                            곳으로,
                ...
                <li className="restaurant">
                    ...
                    <div className="restaurant__info">
                        ...
                        <p className="restaurant__description text-body">Since 2004 편리한 교통과 주차, 그리고 관록만큼 깊은 맛과 정성으로 정통 중식의 세계를 펼쳐갑니다</p>
                    </div>
                </li>

                <li className="restaurant">
                    <div className="restaurant__category">
                        <img src="../../../templates/category-japanese.png" alt="일식" class="category-icon" />
                    </div>
                    <div className="restaurant__info">
                        <h3 className="restaurant__name text-subtitle">잇쇼우</h3>
                        <p className="restaurant__description text-body">잇쇼우는 정통 자가제면 사누끼 우동이 대표메뉴입니다. 기술은 정성을 이길 수 없다는 신념으로 모든 음식에 최선을
                            다하는 잇쇼우는
                ...
                <li className="restaurant">
                    <div className="restaurant__category">
                        <img src="../../../templates/category-western.png" alt="양식" class="category-icon" />
                    </div>
                    <div className="restaurant__info">
                ...
                <li className="restaurant">
                    <div className="restaurant__category">
                        <img src="../../../templates/category-asian.png" alt="아시안" class="category-icon" />
                    </div>
                    <div className="restaurant__info">
                ...
                <li className="restaurant">
                    <div className="restaurant__category">
                        <img src="../../../templates/category-etc.png" alt="기타" class="category-icon" />
                    </div>
                    <div className="restaurant__info">
