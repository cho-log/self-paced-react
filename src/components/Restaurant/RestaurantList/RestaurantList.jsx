    ...
    return (
        ...
        <ul className={`${styles['restaurant-list']}`}>
            ...
            <div className={`${styles['restaurant__category']}`}>
                <img src={koreanFoodIcon} alt="한식" className={`${styles['category-icon']}`}/>
            </div>
            ...
            <li className={`${styles['restaurant']}`}>
            <div className={`${styles['restaurant__category']}`}>
                <img src={chineseFoodIcon} alt="중식" className={`${styles['category-icon']}`}/>
            </div>
            <div className={`${styles['restaurant__info']}`}>
            ...
            <li className={`${styles['restaurant']}`}>
            <div className={`${styles['restaurant__category']}`}>
                <img src={japaneseFoodIcon} alt="일식" className={`${styles['category-icon']}`}/>
            </div>
            <div className={`${styles['restaurant__info']}`}>
            ...
            <li className={`${styles['restaurant']}`}>
            <div className={`${styles['restaurant__category']}`}>
                <img src={westernFoodIcon} alt="양식" className={`${styles['category-icon']}`}/>
            </div>
            <div className={`${styles['restaurant__info']}`}>
            ...
            <li className={`${styles['restaurant']}`}>
            <div className={`${styles['restaurant__category']}`}>
                <img src={asianFoodIcon} alt="아시안" className={`${styles['category-icon']}`}/>
            </div>
            <div className={`${styles['restaurant__info']}`}>
            ...
            <li className={`${styles['restaurant']}`}>
            <div className={`${styles['restaurant__category']}`}>
                <img src={etcFoodIcon} alt="기타" className={`${styles['category-icon']}`}/>
            </div>
            <div className={`${styles['restaurant__info']}`}>
