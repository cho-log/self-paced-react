...
export const RESTAURANTS = [
  ...
  {
    category: '일식',
    categoryIcon: JapaneseIcon,
    name: '잇쇼우',
    description:
      '잇쇼우는 정통 자가제면 사누끼 우동이 대표메뉴입니다. 기술은 정성을 이길 수 없다는 신념으로 모든 음식에 최선을 다하는 잇쇼우는고객 한분 한분께 최선을 다하겠습니다',
  },
  {
    category: '양식',
    categoryIcon: WesternIcon,
