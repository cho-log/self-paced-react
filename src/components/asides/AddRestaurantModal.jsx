import styles from "./RestaurantModal.model.css";
  ...
  return (
    <div className={styles["modal modal--open"]}>
      ...
      <div className={styles["modal-container"]}>
        ...
        <form>
          <div className={styles["form-item form-item--required"]}>
          ...
          <div className={styles["button-container"]}>
            <button className={styles["button button--primary text-caption"]}>
              추가하기
            </button>
          </div>
        </form>
