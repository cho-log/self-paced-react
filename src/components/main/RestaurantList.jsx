...
const restaurants = [
  {
    category: 'korean',
    icon: 'src/assets/images/category/category-korean.png',
    alt: '한식',
    name: '피양콩할머니',
  ...
  {
    category: 'chinese',
    icon: 'src/assets/images/category/category-chinese.png',
    alt: '중식',
    name: '친친',
  ...
  {
    category: 'japanese',
    icon: 'src/assets/images/category/category-japanese.png',
    alt: '일식',
    name: '잇쇼우',
  ...
  {
    category: 'western',
    icon: 'src/assets/images/category/category-western.png',
    alt: '양식',
    name: '이태리키친',
  ...
  {
    category: 'asian',
    icon: 'src/assets/images/category/category-asian.png',
    alt: '아시안',
    name: '호아빈 삼성점',
  ...
  {
    category: 'etc',
    icon: 'src/assets/images/category/category-etc.png',
    alt: '기타',
    name: '도스타코스 선릉점',
